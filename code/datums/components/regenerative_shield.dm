...
/datum/component/regenerative_shield/proc/block_attack(
	...
	playsound(get_turf(parent), 'sound/weapons/tap.ogg', 20, TRUE, FALSE)
...
/datum/component/regenerative_shield/proc/disable_shield()
	...
	playsound(parent, 'sound/mecha/mech_shield_drop.ogg', 20, TRUE, FALSE)
...
/datum/component/regenerative_shield/proc/enable_shield()
	...
	playsound(parent, 'sound/mecha/mech_shield_raise.ogg', 20, TRUE, FALSE)
