...
/datum/component/spin2win/proc/start_spinning(mob/living/spinning_user)
	...
	playsound(spinning_user, 'sound/weapons/fwoosh.ogg', 75, FALSE, TRUE, FALSE)
...
/datum/component/spin2win/proc/stop_spinning(mob/living/user)
	...
	playsound(user, 'sound/weapons/fwoosh.ogg', 75, FALSE, TRUE, FALSE)
...
/datum/component/spin2win/process(seconds_per_tick)
	...
	playsound(item_owner, 'sound/weapons/fwoosh.ogg', 75, FALSE, TRUE, FALSE)
