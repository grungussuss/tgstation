...
/datum/element/kneejerk/proc/tap_knee(obj/item/item, mob/living/target, mob/living/user)
	...
	if(target_brain_damage < BRAIN_DAMAGE_MILD) //a healthy brain produces a normal reaction
		playsound(target, 'sound/weapons/punchmiss.ogg', 25, TRUE, -1, TRUE, FALSE)
		...
		playsound(target, 'sound/weapons/punchmiss.ogg', 15, TRUE, -1, TRUE, FALSE)
		...
		playsound(target, 'sound/weapons/punchmiss.ogg', 5, TRUE, -1, TRUE, FALSE)
