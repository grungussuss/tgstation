...
/datum/sound_effect/soda_can_drop
	key = SFX_SODA_CAN_DROP
	file_paths = list(

	)

/datum/sound_effect/soda_can_pickup
	key = SFX_SODA_CAN_PICKUP
	file_paths = list(

	)

/datum/sound_effect/soda_can_throw_hit
	key = SFX_SODA_CAN_THROW_HIT
	file_paths = list(

	)

/datum/sound_effect/soda_can_throw_drop
	key = SFX_SODA_CAN_THROW_DROP
	file_paths = list(

	)

/datum/sound_effect/soda_can_hit
	key = SFX_SODA_CAN_HIT
	file_paths = list(
...
/datum/sound_effect/soda_can_filled_throw_hit
	key = SFX_SODA_CAN_FILLED_THROW_HIT
	file_paths = list(

	)

/datum/sound_effect/soda_can_filled_throw_drop
	key = SFX_SODA_CAN_FILLED_THROW_DROP
	file_paths = list(

	)

/datum/sound_effect/soda_can_filled_hit
	key = SFX_SODA_CAN_FILLED_HIT
	file_paths = list(
